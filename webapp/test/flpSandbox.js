		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#Ingresosregistros-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Ingresosregistros-display": {
								"semanticObject": "Ingresosregistros",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Ingresos.registros",
									"url": sap.ui.require.toUrl("Ingresos/registros")
								}
							}
						}
					}
